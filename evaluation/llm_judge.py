...
_USEFUL_TERMS = [
    "risk", "investment", "disclaimer", "prediction", "forecast", "data",
    "model", "warning", "accuracy", "nvidia", "lstm", "metric", "rmse",
    "confidence", "uncertainty", "price", "stock", "historical", "evaluate",
]
